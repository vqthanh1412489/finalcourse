...
describe('admin/changeName Router', () => {
    ...
    it('KT can change Name Admin incase right token', () => __awaiter(this, void 0, void 0, function* () {
        const res = yield request(app_1.app).put(`/admin/changeName`)
            .send({ newName: 'VuQuocThanh' })
            .set({ token: tk });
        assert.equal(res.status, 200);
    }));
    it('KT cannot change Name Admin incase wrong token', () => __awaiter(this, void 0, void 0, function* () {
        const res = yield request(app_1.app).put(`/admin/changeName`)
            .send({ newName: 'VuQuocThanh' })
