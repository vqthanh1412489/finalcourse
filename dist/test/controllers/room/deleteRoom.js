...
describe('delete Room Router', () => {
    ...
    it('KT can delete the Room incase idRoom && you are Admin', () => __awaiter(this, void 0, void 0, function* () {
        const response = yield request(app_1.app).delete(`/room/${idRoom}`)
            .set({ token: tk });
        assert.equal(response.status, 200);
    }));
    it('KT cannot delete the Room incase full infor && you arenot Admin', () => __awaiter(this, void 0, void 0, function* () {
        const response = yield request(app_1.app).delete(`/room/${idRoom}`)
